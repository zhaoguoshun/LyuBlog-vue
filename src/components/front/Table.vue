    ...
    <div class="tab_box whitebg">
        ...
        <div class="newstab">
            <div class="newsitem" :v-show="cur==cur">
                <div class="newspic">
                    <ul>
                        <li><router-link :to='"/detail/"+xxxx.id' target="_blank"><img src="@/assets/images/book1.jpg"><span >{{xxxx.title}}</span></router-link></li>

                        <li><router-link :to='"/detail/"+yyyy.id' target="_blank" ><img src="@/assets/images/book2.jpg"><span>{{yyyy.title}}</span></router-link></li>
                    </ul>
                </div>
                <ul class="newslist">
